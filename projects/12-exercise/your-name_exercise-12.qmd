...
- You'll need to make a copy of `states_with_regions` that has the states shifted around using `shift_geometry()` ([see the example](https://timmarchand.github.io/iss_dataviz/example/12-example.html#us-map-with-non-continguous-parts))
...
- You'll need to make a copy of that joined dataset that has the states shifted around using `shift_geometry()` ([see the example](https://timmarchand.github.io/iss_dataviz/example/12-example.html#us-map-with-non-continguous-parts))
