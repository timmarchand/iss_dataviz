...
If you have covered the previous unit too, look at the `Uncertainty_plots.R` code, and play around with the themes for the `pyramid`, `ridges`, `halves`, and `raincloud` plots. 
