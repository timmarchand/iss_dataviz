---
title: "Themes"
subtitle: "Exercise 5 --- ISS dataviz, Spring 2026"
...
- The image is 6 inches wide and 3 inches tall. Use chunk options like `fig-width` and `fig-height` to control the dimensions (see <https://timmarchand.github.io/iss_dataviz/resource/quarto.html#chunk-options>)
...
**MAKE SURE** you use [the theme resources and cheatsheets from the content page](https://timmarchand.github.io/iss_dataviz/content/05-content.html#readings-you-should-glance-through-and-use-as-resources). Also [consider using {ggthemeassist}](https://timmarchand.github.io/iss_dataviz/example/05-example.html#bonus-ggthemeassist) to help with the different settings.
...
# Task 4: ~~Extension~~ Uncertainty plots

If you have covered the following unit too, look at the `Uncertainty_plots.R` code, and play around with the themes for the `pyramid`, `ridges`, `halves`, and `raincloud` plots. 

```{r}
#| label: uncertainty-extension
source("Uncertainty_plots.R")
