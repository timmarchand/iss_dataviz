...
- Notice that the y-axis is logged and uses automatic dollar labels. You'll want to use `scale_y_log10()` and something from the {scales} package for adjusting the labels. [See this FAQ post](https://timmarchand.github.io/iss_dataviz/news/2025-10-08_faqs_week_06.html#i-have-numbers-like-20000-and-want-them-formatted-with-commas-like-20000.-can-i-do-that-automatically) for help.
