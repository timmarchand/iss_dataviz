...
graph LR
  ...
  subgraph Graph
    ...
    xae82ef75be61abf5(["data_gapminder"]):::completed --> x527abcc5677dae68(["build_data"]):::queued
    ...
    xecbe992e9bd44ed2(["get_data_wdi_comparisons"]):::completed --> xea52756aad62ec59(["data_wdi_comparisons"]):::queued
    x492aec160c1eec8d(["get_data_wdi_lifeexp"]):::completed --> x8dfde51a0d28871a(["data_wdi_lifeexp"]):::queued
    ...
    x2e8be840059eefe5(["proj_07_exercise_files"]):::completed --> x240b9eb72136885f["proj_07_exercise"]:::queued
    ...
    x83c90c487d16eadc(["schedule_file"]):::completed --> xd1e486155305a9d8(["schedule_ical_data"]):::queued
    xd1e486155305a9d8(["schedule_ical_data"]):::queued --> xe96618267648362b(["schedule_ical_file"]):::queued
    x83c90c487d16eadc(["schedule_file"]):::completed --> x7f26ad8951796691(["schedule_page_data"]):::queued
    ...
    x56b35e682aae9edd(["slide_rmd_10_slides_files"]):::completed --> xe4f696ed33dca3d5["slide_rmd_10_slides"]:::queued
