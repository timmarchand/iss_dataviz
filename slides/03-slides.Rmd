...
```{r show-ggplot-template, echo=FALSE, results='asis'}
cat('
<pre><code>ggplot(data = <b style="background:#CBB5FF">DATA</b>) +
  <b style="background:#FFDFD1">GEOM_FUNCTION</b>(mapping = aes(<b style="background:#FFD0CF">AESTHETIC MAPPINGS</b>))
</code></pre>
')
```
...
```{r ggplot-template-example, echo=FALSE, results='asis'}
cat('
<pre><code>ggplot(data = <b style="background:#CBB5FF">troops</b>) +
  <b style="background:#FFDFD1">geom_path</b>(mapping = aes(x = <b style="background:#FFD0CF">longitude</b>,
                          y = <b style="background:#FFD0CF">latitude</b>,
                          color = <b style="background:#FFD0CF">direction</b>,
                          linewidth = <b style="background:#FFD0CF">survivors</b>))
</code></pre>
')
```
