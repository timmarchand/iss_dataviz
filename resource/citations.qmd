...
2. Set "Use libraries" to "Selected Libraries" and make sure "My Library" is checked (that's your stuff that you add on your own), and that [the group library that you've joined from here](https://datavizsp26.classes.andrewheiss.com/resource/citations.html) is checked.
