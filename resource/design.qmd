...
- [**CARTOColors**](https://carto.com/carto-colors/): More sequential, diverging, and qualitative color palettes that take accessibility into account. Use them with [{rcartocolor}](https://jakubnowosad.com/rcartocolor/).
...
- [**fontpair**](https://www.fontpair.co/all): A directory of all sorts of Google Fonts pairings (for when you're looking for good contrasting or complementary fonts)
- [**The Ultimate Collection of Google Font Pairings**](https://www.reliablepsd.com/ultimate-google-font-pairings/): Another list of great, well-designed font pairings
- [**"Pairing typefaces"**](https://fonts.google.com/knowledge/choosing_type/pairing_typefaces): Google Fonts's own guidelines for finding good pairings
- [**Font Mixer**](https://fontmixer.app/): An online app for finding and testing different font combinations
