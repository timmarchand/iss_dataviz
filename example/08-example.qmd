...
# 1. Pull the data from targets
tar_load(get_data_wdi_annotations)

# 2. Rename it to what the rest of the file expects
wdi_clean <- get_data_wdi_annotations

# 3. Ensure the WDI path for the download link works
